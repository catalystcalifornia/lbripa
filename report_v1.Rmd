...
# define colors
col <-c("#9B9A9A", meteorite, lavender, orange,peridot,"#177FEB", "#733256" )  
...
hctreemap2(df, 
           group_vars = "stop_reason_short",
           size_var = "hours_rate",
           tooltip = list(pointFormat = "Out of 100 hours, LBPD spent <b>{point.hours_rate:.1f}</b> hours on stops for <b>{point.stop_reason_short}</b>")) %>%
