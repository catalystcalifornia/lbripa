...
# colors according to our brand guide:
#2BC433
#362178
#F25922
#CEEA01
...
demographic_popup <- paste0((
  label = paste0(
    ...
    council_district_demographics$council_num, "</span> consists of <span style='font-size: 12px; font-weight: bold;'><br>",
    
    council_district_demographics$aian_rate,"</span> American Indian and Alaska Native, <span style='font-size: 12px; font-weight: bold;'>",  
    
    council_district_demographics$latinx_rate, "</span> Latinx,  <span style='font-size: 12px; font-weight: bold;'>",
    
    council_district_demographics$mesa_rate, "</span> Middle Eastern or South Asian, <span style='font-size: 12px; font-weight: bold;'>",
    
    council_district_demographics$nh_asian_rate,"</span> Asian,    <span style='font-size: 12px; font-weight: bold;'>",  
    
    council_district_demographics$nh_black_rate,"</span> Black,    <span style='font-size: 12px; font-weight: bold;'>", 
    
    council_district_demographics$nh_other_rate,"</span> Other, <span style='font-size: 12px; font-weight: bold;'>", 
    
    council_district_demographics$nh_twoormor_rate,"</span> Two or More, <span style='font-size: 12px; font-weight: bold;'>", 
    
    council_district_demographics$nh_white_rate, "</span> White,  <span style='font-size: 12px; font-weight: bold;'>",  
    
    council_district_demographics$nhpi_rate, "</span> Native Hawaiian or Pacific Islander.")
))
...
leaflet(width = "100%", height = "495px") %>%
  ...
  hideGroup(c( "Latinx", "White","Asian", "Two or More Races", "AIAN", "NHPI", "MESA"))  #base and view 
...
pal_total <- colorQuantile("Blues", council_district_rate$traffic_stop_rate, n = 5)
