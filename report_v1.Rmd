...
colors_function_line <- function(colors, sizes, borders, shapes) {
  shapes <- gsub("dashed", "100%", shapes)
  paste0(colors, "; width:", sizes, "px; height:", sizes, "px; border:1px solid ", borders, "; border-radius:", shapes)
}
...
leaflet(width = "100%", height = "495px") %>%
  ...
  addPolylines(data = high_injury_motor_corridors_line_sf, group = "High Injury Motor Intersections/Corridors",
              ...
              color = peridot, weight = 2, opacity = 2) %>%
  ...
  addPolylines(data = high_injury_ped_corridors_line_sf, group = "High Injury Pedestrian or Bike Intersections/Corridors",
               ...
               color = papaya_orange, weight = 2, opacity = 2) %>%
  ...
  addCircleMarkers(data = high_injury_motor_intersections_spdf, lat = ~lat, lng = ~lon,
                   ...
                   weight = 2, fillOpacity = 1, radius=4,
                    color = "black", fillColor= peridot, stroke = TRUE
  ) %>%
...
## add legend for corridors
   addLegend(position = "bottomleft",   title = "", group = "High Injury Motor Intersections/Corridors", labels = "Motor Corridors", colors = colors_function_line(colors =peridot, sizes = "10", shapes = "dashed", borders = NULL) ) %>%
  ...
  ## add legend for corridors
   addLegend(position = "bottomleft",   title = "", group = "High Injury Pedestrian or Bike Intersections/Corridors", labels = "Pedestrian or Bike Corridors", colors = colors_function_line(colors =papaya_orange, sizes = "10", shapes = "dashed", borders = NULL) ) %>%
