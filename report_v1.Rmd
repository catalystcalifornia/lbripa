...
# round rates
df_stop<-mutate(df_stop,
                aian_stop_rate_per1k = round(aian_stop_rate_per1k,1),
                latinx_stop_rate_per1k = round(latinx_stop_rate_per1k,1),
                nh_asian_stop_rate_per1k = round(nh_asian_stop_rate_per1k,1),
                nh_black_stop_rate_per1k = round(nh_black_stop_rate_per1k,1),
                nh_twoormor_stop_rate_per1k=round(nh_tworomor_stop_rate_per1k,1),
                nh_white_stop_rate_per1k = round(nh_white_stop_rate_per1k,1),
                nhpi_stop_rate_per1k = round(nhpi_stop_rate_per1k,1),
                mesa_stop_rate_per1k = round(mesa_stop_rate_per1k,1),
                total_stop_rate_per1k = round(total_stop_rate_per1k,1))
