...
Examining data from the Racial & Identity Profiling Act we find that LBPD spends most of their time on officer-initiated stops for traffic reasons. These stops do not add up to preventing or detecting serious crimes. Instead, they subject low-income communities of Long Beach to undue policing. These communities disproportionately impacted by policing are the same communitie4s that have historically had the fewest resources for other services. The inequities and ineffectiveness of these practices demand investments in alternatives in the city.
