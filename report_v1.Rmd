...
## Carousel
Combines last three charts
```{r echo=FALSE}
library(slickR)

htmlwidgets::saveWidget(tree_chart,'tree_chart.html', selfcontained = FALSE)
htmlwidgets::saveWidget(item_chart,'item_chart.html', selfcontained = FALSE)

tree_widget <- includeHTML('tree_chart.html')
item_widget <- includeHTML('item_chart.html')
flextable_widget <- to_html(ft) # to_html works specifically with flextables

carousel <- slickR::slickR(c(tree_widget, item_widget, flextable_widget), 
               slideType="iframe",
               width='90%',
               height=600) +
