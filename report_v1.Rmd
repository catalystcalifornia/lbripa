...
hc<-hchart(
  ...
  "item",
  rows=8,
  tooltip = list(pointFormat = "Out of 100 hours, LBPD spent {point.hours_rate:.1f} hours on traffic stops that resulted in {point.stop_result_short}"),
  hcaes(
  ...
  hc_legend(title=list(text='<span style="font-size: 12px; color: #000000; font-weight: bold">Single dot represents 1 hour out of 100 hours</span><br/><span style="font-size: 10px; color: #666; font-style: italic">Click to hide</span><br><br>'),
            enable = TRUE, 
