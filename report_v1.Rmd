...
addControl(html='<div class="leaflet-popup-scrolled point-density-sidebar"><div class ="cd-header" style="margin-bottom: 8px; margin-top: 8px;">Council District <span class="cd" style="font-size: 16px; font-weight: bold;"></span></div><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nh-black-color"></span>Black stop rate per 1k: <span class="nh-black-stop-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nh-black-color"></span>Black population rate: <span class="nh-black-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon latinx-color"></span>Latinx stop rate per 1k: <span class="latinx-stop-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon latinx-color"></span>Latinx population rate: <span class="latinx-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nh-asian-color"></span>Asian stop rate per 1k: <span class="nh-asian-stop-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nh-asian-color"></span>Asian population rate: <span class="nh-asian-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nh-white-color"></span>White stop rate per 1k: <span class="nh-white-stop-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nh-white-color"></span>White population rate: <span class="nh-white-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon mesa-color"></span>MESA stop rate per 1k: <span class="mesa-stop-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon mesa-color"></span>MESA population rate: <span class="mesa-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nhpi-color"></span>NHPI stop rate per 1k: <span class="nhpi-stop-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nhpi-color"></span>NHPI population rate: <span class="nhpi-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon aian-color"></span>AIAN stop rate per 1k: <span class="aian-stop-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon aian-color"></span>AIAN population rate: <span class="aian-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nh-twoormor-color"></span>Two or More Races stop rate per 1k: <span class="nh-twoormor-stop-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 12px; font-weight:bold; line-height: 1.5em;"><span class="circle-icon nh-twoormor-color"></span>Two or More Races population rate: <span class="nh-twoormor-rate" style="font-size: 12px; font-weight: bold;"></span><br><span style="font-size: 10px; font-style: italic;">*Each dot represents 10 people stopped by LBPD.</span></div>', position = "topleft") %>%
...
total_traffic_rate_popup <- paste0((
 label = paste0(
    "For every 1K <span style='font-weight: bold;'>Total</span> people in   <span style='font-size: 12px; font-weight: bold;'>",  
    
    
  "<a href=",council_district_traffic_rate$link, ">", "</span> Council District <span style='font-size: 12px; font-weight: bold;'>",  council_district_traffic_rate$council_num, "</span>", "</a>", ", LBPD stopped <span style='font-size: 12px; font-weight: bold;'>",council_district_traffic_rate$total_traffic_stop_rate, "</span>  people, a total of <span style='font-size: 12px; font-weight: bold;'> ", scales::comma(council_district_traffic_rate$total_traffic_stop_count), "</span> people. ")))
