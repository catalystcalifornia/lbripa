...
df %>%
  ...
  hc_title(text = "Four in five hours are spent on officer-initiated stops not calls for service",
 align="left")%>%
...
fx_lollichart(
  ...
  top_finding=paste0("Black people are most likely to be stopped for minor traffic stops."), # this is the top finding from the chart that gets used like a title
...
label = paste0(
   "In Council District  <span style='font-size: 12px; font-weight: bold;'>",  
 ...
 scales::comma(council_district_noaction$hours_rate_noaction_cap, accuracy = 0.1), "</span>%, a total of <span style='font-size: 12px; font-weight: bold;'> ", scales::comma(council_district_noaction$hours_count_noaction_cap, accuracy = 0.1), "</span> hours.")))
...
We compared 2019 traffic stops to high-injury corridors and intersections identified by the Safe Streets Long Beach initiative. The initiative identified these high-injury corridors and intersections based on 2015-17 data, but they remain the initiative's action plan to guarantee equity in increasing road safety. Council Districts 1 and 6 have the highest rate of traffic stops, but they also have the highest concentration of high-injury motor, pedestrian, and bike networks. Rather than improving safety in these highly impacted communities, officer-initiated traffic stops can lead to greater harm by more contact and exposure to the police. 
...
Instead of creating safer communities, officers use routine traffic stops as a means to profile and harass people of color. LBPD officers
